...
def climate_impact(
    ...
    return climate_service.climate_impact(db, period)
...
def pilot(
    ...
    return pilot_service.run_pilot(db, request, period, persist=False)
...
def run_pilot(
    ...
    return pilot_service.run_pilot(db, request, request.period or period, persist=True)
