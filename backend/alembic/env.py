...
Migrations exist for the PostgreSQL deployment. The SQLite development
database is built directly from the models by `create_all`, so a fresh
checkout runs without touching this file.
